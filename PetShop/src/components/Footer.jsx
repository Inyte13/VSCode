    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.containerRows}>
          ...
          <div>
            ...
            <a href='https://www.superpet.pe/libro-de-reclamaciones' target='_blank' rel='noreferrer'>
          ...
          <div>
            <span>SuperPet</span>
            <ul>
              <li><a href='https://www.superpet.pe/quienes-somos-superpet.html' title='Quienes somos' target='_blank' rel='noreferrer'>Acerca de SuperPet</a></li>
              <li><a href='https://pe.computrabajo.com/superpet' target='_blank' title='Trabaja con nosotros' rel='noreferrer'>Trabaja con nosotros</a></li>
              <li><a href='https://www.superpet.pe/politica-de-privacidad-superpet.html' target='_blank' rel='noreferrer'>Política de Privacidad</a></li>
              <li><a href='https://www.superpet.pe/eventos-y-actividades-superpet.html' target='_blank' rel='noreferrer'>Eventos y actividades</a></li>
              <li><a href='https://www.superpet.pe/super-solidarios.html' title='Jornadas de adopción' target='_blank' rel='noreferrer'>Jornadas de adopción</a></li>
              <li><a href='https://www.superpet.pe/charlas-online.html' title='Charlas online' target='_blank' rel='noreferrer'>Charlas online</a></li>
            </ul>
          </div>
      ...
      <div className={styles.footerBottom}>
        ...
        <div className={styles.socialLinks}>
          <ul>
            <li>
              <a href='https://www.instagram.com/superpet_pe' target='_blank' rel='noreferrer'>
            ...
            <li>
              <a href='https://www.facebook.com/superpet.pe' target='_blank' rel='noreferrer'>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5l0-170.3-52.8 0 0-78.2 52.8 0 0-33.7c0-87.1 39.4-127.5 125-127.5 16.2 0 44.2 3.2 55.7 6.4l0 70.8c-6-.6-16.5-1-29.6-1-42 0-58.2 15.9-58.2 57.2l0 27.8 83.6 0-14.4 78.2-69.3 0 0 175.9C413.8 494.8 512 386.9 512 256z' /></svg>
              </a>
            </li>
            <li>
              <a href='https://www.youtube.com/channel/UCMcd3FCBavw7fVgQR0Fi-2w' target='_blank' rel='noreferrer'>
            ...
            <li>
              <a href='https://pe.linkedin.com/company/mascotaslatinas' target='_blank' rel='noreferrer'>
