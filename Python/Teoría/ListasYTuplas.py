...
nombresL.pop(0) # Elimina el elemento en la posición 0, PUEDES PONER (-1, -2, etc.) para eliminar desde el final
...
num.sort(reverse=True) # Ordena la lista de mayor a menor, los true y false son 1 y 0 
num.reverse() # Revierte el orden de la lista
