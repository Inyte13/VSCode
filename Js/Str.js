...
const nombre="Oriana"
console.log(`${nombre} es perfecta`)
...
const str3="Si estás leyendo esto espero que estés bien"
...
// pad
const num="5"
num.padStart(4,"0") // "0005", autocompconsta con "0" por el inicio hasta que su length sea 4 
num.padEnd(4,"0") // "0005", autocompconsta con "0" por el final hasta que su length seaz 4
